...
wget -c http://prdownloads.sourceforge.net/e2fsprogs/e2fsprogs-1.42.tar.gz
...
wget -c http://ftp.gnu.org/gnu/gzip/gzip-1.4.tar.gz
wget -c http://ftp.gnu.org/gnu/inetutils/inetutils-1.9.1.tar.gz
wget -c http://anduin.linuxfromscratch.org/sources/LFS/lfs-packages/conglomeration/kbd/kbd-1.15.2.tar.gz
...
wget -c http://prdownloads.sourceforge.net/psmisc/psmisc-22.15.tar.gz
...
wget -c http://prdownloads.sourceforge.net/tcl/tcl8.5.11-src.tar.gz
wget -c http://ftp.gnu.org/gnu/texinfo/texinfo-4.13a.tar.gz
wget -c http://ftp.gnu.org/gnu/autoconf/autoconf-2.68.tar.bz2
...
wget -c http://www.linuxfromscratch.org/lfs/downloads/7.1/udev-config-20100128.tar.bz2
