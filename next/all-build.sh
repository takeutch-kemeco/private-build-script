...
__openssh-6.8p1()
{
    ...
    __wget http://ftp.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-6.8p1.tar.gz
    __decord openssh-6.8p1
    __cd openssh-6.8p1
    ...
    sudo install -v -m755 -d /usr/share/doc/openssh-6.8p1
    sudo install -v -m644 INSTALL LICENCE OVERVIEW README* /usr/share/doc/openssh-6.8p1
}
